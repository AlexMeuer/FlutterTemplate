...
typedef Widget HandlerWithArgsFunc(BuildContext context,
    Map<String, List<String>> parameters, Object arguments);

class HandlerWithArgs implements Handler {
  final HandlerType type;
  final HandlerWithArgsFunc handlerWithArgsFunc;

  Object arguments;

  HandlerWithArgs({
    this.type = HandlerType.route,
    @required this.handlerWithArgsFunc,
  });
  ...
  get handlerFunc =>
      (BuildContext context, Map<String, List<String>> parameters) {
        try {
          return handlerWithArgsFunc(context, parameters, arguments);
        } finally {
          arguments = null;
        }
      };
...
class ModifiedRouter implements Router {
  ...
  RouteMatch matchRoute(
    ...
    ////////////////////////////////////////////////////////////////////////////
    /// BEGIN TRAVEL BUG MODIFICATIONS
    ////////////////////////////////////////////////////////////////////////////
    Handler handler = (route != null ? route.handler : notFoundHandler);
    if (handler is HandlerWithArgs) {
      handler.arguments = routeSettings?.arguments;
    }
    ////////////////////////////////////////////////////////////////////////////
    /// END TRAVEL BUG MODIFICATIONS
    ////////////////////////////////////////////////////////////////////////////
